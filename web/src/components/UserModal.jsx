      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 py-8">
            ...
            >
              <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-lg bg-dark-900 border border-dark-800 shadow-xl transition-all max-h-[90vh] flex flex-col">
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto">
                  <div className="p-6 space-y-4">
                    ...
                    <div>
                      ...
                      {user && user.role === 'owner' && (
                        <p className="text-xs text-dark-500 mt-1">Owner role cannot be changed</p>
                      )}
                    </div>
                  ...
                  <div className="flex justify-end gap-3 p-6 pt-4 border-t border-dark-800 flex-shrink-0">
                    <button
                      type="button"
                      onClick={onClose}
